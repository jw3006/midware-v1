...
class Advance extends REST_Controller
{
    ...
    public function index_get()
    {
        ...
        if ($auth == true) {
            $id = $this->get('id');
            if ($id == '') {
                $data = $this->interface_model->get_advance();
            ...
            $this->response([
                'status' => true,
                'message' => 'The advance data has been generated.',
                'data' => $data,
                'notif' => $notif
        ...
        if ($auth == true) {
            ...
            if ($result['status'] == 'E') {
                ...
                if ($Code) {
                    ...
                    $this->response([
                        'status' => true,
                        'message' => 'The advance data has been reposted.',
                        'data' => $id
                    ], REST_Controller::HTTP_OK);
                } else {
    ...
    public function index_delete()
    {
        ...
        if ($auth == true) {
            ...
            if ($result) {
                $this->response([
                    'status' => 'success',
                    'message' => 'The advance data has been deleted.',
                    'data' => $code
                ], REST_Controller::HTTP_OK);
            } else {
                $this->response([
