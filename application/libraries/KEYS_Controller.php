...
class KEYS_Controller
{
    ...
    public function _generate_key($data)
    {
    ...
    public function _check_keys($data)
    {
        $secret_key = $this->privateKey();
        $decode = JWT::decode($data, $secret_key, array('HS256'));
        return $decode;
    }

    public function _check_auth($data)
    {
